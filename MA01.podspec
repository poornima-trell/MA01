...
s.source_files = 'MA01/**/*'
s.resources = ["MA01/**/*.{png,jpeg,jpg,storyboard,xib,json}","MA01/*.*/*.{png,jpeg,jpg,storyboard,xib,json}","MA01/MA01/Assets.xcassets/AppIcon.appiconset/*.{png,jpeg,jpg,storyboard,xib,json}"]
